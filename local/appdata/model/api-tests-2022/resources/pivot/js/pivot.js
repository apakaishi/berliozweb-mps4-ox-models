  ...
  callWithJQuery(function($) {
    ...
    renderers = {
      ...
      "CSV Export": function(pivotData, opts) {
    	  var agg, colAttrs, colKey, colKeys, defaults, i, j, k, l, len, len1, len2, len3, len4, len5, m, n, r, result, row, rowAttr, rowAttrs, rowKey, rowKeys, text, textr;
          defaults = {
            localeStrings: {}
          };
          ...
          return $("<textarea id='mytextarea' ondblclick='save()'>").text(text).css({
      ...
      for (j in colAttrs) {
        ...
        for (i in colKeys) {
          ...
          if (x !== -1) {
            ...
            if(c === "color"){
            	var pos =  String(colKey).indexOf("#");
            	var contentColor =  String(colKey);
            	if(pos !== -1){
              	  var color_prop =  contentColor.substr(pos,7);
            	  th.setAttribute("style", c + ":" + color_prop);
            	}  
            }
      ...
      for (i in rowKeys) {
        ...
        for (j in rowKey) {
          ...
          if (x !== -1) {
            ...
            var contains = String(rowKey).includes("#");
            var pos =  String(rowKey).indexOf("#");
            
            if(contains && pos !== -1){
             	var color_prop =  String(rowKey).substr(pos,7);
             	var contentContains = String(txt).includes("#");
                if(contentContains){
            	  th.setAttribute("style", "color:" + color_prop);
                }  
          	}                        
    ...
    $.fn.pivotUI = function(input, inputOpts, overwrite, locale) {
      ...
      try {
        ...
        rendererControl = $("<td>").addClass("pvtUiCell").addClass("pvtVals");
        ...
        $("<td>").addClass('pvtAxisContainer pvtHorizList pvtCols pvtUsed pvtUiCell').appendTo(tr1);
        tr2 = $("<tr>").appendTo(uiTable);
        tr2.append($("<td>").addClass('pvtAxisContainer pvtRows pvtUsed pvtUiCell').attr("valign", "top"));
